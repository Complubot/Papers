...
Along the paper the focus will be on the software developed for the platform itself as well as the ROS software developed for the required tasks.
...
The partial results of the different algorithms are combined with a kalman like filter to estimate the best course of action that the robot should perform to follow a selected target.
